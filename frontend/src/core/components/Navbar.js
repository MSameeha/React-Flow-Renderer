...
import Logo from "../media/swayam_logo-removebg-preview.png";*/
import Logo from "../media/flowtion.png";
	...
	if(width > 720)
	{
		...
		<div className="Nav-front">
			<NavLink to="/" className="">
				<img src={Logo} alt="swayam-logo"></img>
			</NavLink>
		</div>
		...
		return(
			<>
				<div className='nav-toggle-main'>
					...
					<span className='nav-toggle-title'>FlowTion</span>
				</div>
